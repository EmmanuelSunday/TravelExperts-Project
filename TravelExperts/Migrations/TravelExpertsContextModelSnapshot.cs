...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelExperts.Models.Affiliation", b =>
                {
            ...
            modelBuilder.Entity("TravelExperts.Models.Agency", b =>
                {
                    ...
                    b.Property<string>("AgncyPicture")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("TravelExperts.Models.Agent", b =>
                {
            ...
            modelBuilder.Entity("TravelExperts.Models.Booking", b =>
                {
            ...
            modelBuilder.Entity("TravelExperts.Models.BookingDetail", b =>
                {
            ...
            modelBuilder.Entity("TravelExperts.Models.Class", b =>
                {
                    b.Property<string>("ClassId")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
            ...
            modelBuilder.Entity("TravelExperts.Models.CreditCard", b =>
                {
            ...
            modelBuilder.Entity("TravelExperts.Models.Customer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TravelExperts.Models.CustomersReward", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExperts.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("TravelExperts.Models.Fee", b =>
                {
                    b.Property<string>("FeeId")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("TravelExperts.Models.Package", b =>
                {
                    b.Property<int>("PackageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TravelExperts.Models.PackagesProductsSupplier", b =>
                {
                    b.Property<int>("PackageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExperts.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("TravelExperts.Models.ProductsSupplier", b =>
                {
                    b.Property<int>("ProductSupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TravelExperts.Models.Region", b =>
                {
                    b.Property<string>("RegionId")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
            ...
            modelBuilder.Entity("TravelExperts.Models.Reward", b =>
                {
                    b.Property<int>("RewardId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExperts.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TravelExperts.Models.SupplierContact", b =>
                {
            ...
            modelBuilder.Entity("TravelExperts.Models.TripType", b =>
                {
                    b.Property<string>("TripTypeId")
                        .HasMaxLength(1)
                        .HasColumnType("nvarchar(1)");
            ...
            modelBuilder.Entity("TravelExperts.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TravelExperts.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TravelExperts.Models.Agent", b =>
                {
                    b.HasOne("TravelExperts.Models.Agency", "Agency")
                        .WithMany("Agents")
            ...
            modelBuilder.Entity("TravelExperts.Models.Booking", b =>
                {
                    b.HasOne("TravelExperts.Models.Customer", "Customer")
                        .WithMany("Bookings")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("Bookings_FK00");

                    b.HasOne("TravelExperts.Models.Package", "Package")
                        .WithMany("Bookings")
                        .HasForeignKey("PackageId")
                        .HasConstraintName("Bookings_FK01");

                    b.HasOne("TravelExperts.Models.TripType", "TripType")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("TravelExperts.Models.BookingDetail", b =>
                {
                    b.HasOne("TravelExperts.Models.Booking", "Booking")
                        .WithMany("BookingDetails")
                        .HasForeignKey("BookingId")
                        .HasConstraintName("FK_BookingDetails_Bookings");

                    b.HasOne("TravelExperts.Models.Class", "Class")
                        .WithMany("BookingDetails")
                        .HasForeignKey("ClassId")
                        .HasConstraintName("FK_BookingDetails_Classes");

                    b.HasOne("TravelExperts.Models.Fee", "Fee")
                        .WithMany("BookingDetails")
                        .HasForeignKey("FeeId")
                        .HasConstraintName("FK_BookingDetails_Fees");

                    b.HasOne("TravelExperts.Models.ProductsSupplier", "ProductSupplier")
                        .WithMany("BookingDetails")
                        .HasForeignKey("ProductSupplierId")
                        .HasConstraintName("FK_BookingDetails_Products_Suppliers");

                    b.HasOne("TravelExperts.Models.Region", "Region")
                        .WithMany("BookingDetails")
            ...
            modelBuilder.Entity("TravelExperts.Models.Customer", b =>
                {
                    b.HasOne("TravelExperts.Models.Agent", "Agent")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("TravelExperts.Models.CustomersReward", b =>
                {
                    ...
                    b.HasOne("TravelExperts.Models.Reward", "Reward")
                        .WithMany("CustomersRewards")
            ...
            modelBuilder.Entity("TravelExperts.Models.ProductsSupplier", b =>
                {
                    b.HasOne("TravelExperts.Models.Product", "Product")
                        .WithMany("ProductsSuppliers")
                        .HasForeignKey("ProductId")
                        .HasConstraintName("Products_Suppliers_FK00");

                    b.HasOne("TravelExperts.Models.Supplier", "Supplier")
                        .WithMany("ProductsSuppliers")
            ...
            modelBuilder.Entity("TravelExperts.Models.SupplierContact", b =>
                {
                    b.HasOne("TravelExperts.Models.Affiliation", "Affiliation")
